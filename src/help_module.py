        ...
        'items': [
            {
                ...
                'js': 'pins.digitalWritePin(DigitalPin.P8, 1)',
                'py': 'pins.digital_write_pin(DigitalPin.P8, 1)',
                'note_fr': 'P8 = gauche, P12 = droite, 1 = on, 0 = off',
                'note_en': 'P8 = left, P12 = right, 1 = on, 0 = off',
                'note_ar': 'P8 = يسار، P12 = يمين، 1 = تشغيل، 0 = إيقاف',
            },
            {
                'pattern_fr': 'Allumer LED droite', 'pattern_en': 'Turn on right LED', 'pattern_ar': 'تشغيل المصباح الأيمن',
                'js': 'pins.digitalWritePin(DigitalPin.P12, 1)',
                'py': 'pins.digital_write_pin(DigitalPin.P12, 1)',
        ...
        'items': [
            {
                ...
                'js': 'maqueen.showColor(neopixel.colors(NeoPixelColors.Red))',
                'py': 'maqueen.show_color(neopixel.colors(NeoPixelColors.RED))',
            ...
            },
            {
                ...
                'js': 'maqueen.showColor(neopixel.rgb(255, 100, 0))',
                'py': 'maqueen.show_color(neopixel.rgb(255, 100, 0))',
            ...
            },
            {
                ...
                'js': 'maqueen.showColor(neopixel.colors(NeoPixelColors.Black))',
                'py': 'maqueen.show_color(neopixel.colors(NeoPixelColors.BLACK))',
                'note_fr': 'Black = éteint', 'note_en': 'Black = off', 'note_ar': 'Black = إيقاف',
            },
        ],
    },
    {
        ...
        'items': [
            {
                ...
                'js': 'let left = pins.digitalReadPin(DigitalPin.P13)',
                'py': 'left = pins.digital_read_pin(DigitalPin.P13)',
                'note_fr': '0 = noir (ligne détectée), 1 = blanc',
                'note_en': '0 = black (line detected), 1 = white',
                'note_ar': '0 = أسود (تم كشف الخط)، 1 = أبيض',
            },
            {
                'pattern_fr': 'Lire distance ultrasons', 'pattern_en': 'Read ultrasonic distance', 'pattern_ar': 'قراءة المسافة بالموجات فوق الصوتية',
                'js': 'let d = maqueen.Ultrasonic(PingUnit.Centimeters)',
                'py': 'd = maqueen.ultrasonic(PingUnit.CENTIMETERS)',
        ...
        'items': [
            {
                ...
                'js': 'pins.servoWritePin(AnalogPin.P1, 90)',
                'py': 'pins.servo_write_pin(AnalogPin.P1, 90)',
                'note_fr': 'Angle 0-180° · P1 = S1, P2 = S2',
                'note_en': 'Angle 0-180° · P1 = S1, P2 = S2',
                'note_ar': 'زاوية 0-180° · P1 = S1، P2 = S2',
            },
        ],
    },
    {
...
FAQ = [
    ...
    },
    {
        ...
        'a_fr': [
            ...
            '✓ Utilise maqueen.showColor() et non neopixel direct',
            '✓ Les LEDs RGB sont sur P15 (géré automatiquement par la librairie Maqueen)',
            '✓ Pour une couleur très vive, utilise 255 par canal (ex: rgb(255,0,0))',
        ],
        'a_en': [
            '✓ Install the "neopixel" extension in addition to "maqueen"',
            '✓ Use maqueen.showColor() rather than neopixel directly',
            '✓ RGB LEDs are on P15 (handled automatically by the Maqueen library)',
            '✓ For very bright color, use 255 per channel (e.g. rgb(255,0,0))',
        ],
        'a_ar': [
            '✓ ثبّت امتداد «neopixel» بالإضافة إلى «maqueen»',
            '✓ استخدم maqueen.showColor() وليس neopixel مباشرة',
            '✓ مصابيح RGB على P15 (تُدار تلقائياً بمكتبة Maqueen)',
